...
* Eliminated an engineering bottleneck and saved ~150 hours/year by writing an automated Audio-Playback Latency test for Snap’s hardware product: Spectacles.
* Wrote signal processing functionality to extract relevant information from audio waveforms generated by the target device.
* Published a running metrics to an internal dashboard by configuring a nightly schedule to track changes over time.
* C/C++, Python, Java, Android/ADB, Linux, Bash Scripting, Automation, Signal Processing
</details>
